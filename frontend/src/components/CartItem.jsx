...
const CartItem = ({ item }) => {
  ...
  const handleDecreaseQuantity = () => {
    if (item.quantity === 1) {
      // Ако количеството е 1 и се намали, премахваме продукта
      removeFromCart(item._id);
      toast.success("Продуктът е премахнат от количката!");
    } else {
      // В противен случай намаляваме количеството
        ...
        <div className="flex items-center justify-between md:order-3 md:justify-end">
          <div className="flex items-center gap-2">
            <button
              ...
              onClick={handleDecreaseQuantity} // Обновен обработчик за намаляване
            >
          ...
          <div className="text-end md:order-4 md:w-32">
            <p className="text-base font-bold text-emerald-400">{item.price} лв.</p>
          </div>
        </div>
